  ...
  return (
    ...
    >
      ...
      <text
        ...
        textAnchor="middle"
        fill="#64a70b"
        style={{ font: '700 44px Figtree, sans-serif', letterSpacing: '-0.01em' }}
      >
        HTG-30
      </text>
      <text
        ...
        textAnchor="middle"
        fill="#ffffff"
        style={{ font: '500 13px Figtree, sans-serif', letterSpacing: '0.14em' }}
      >
        TIRAGORDURAS
      </text>
      {/* volume tag */}
      ...
      <text
        ...
        textAnchor="middle"
        fill="#ffffff"
        style={{ font: '600 15px Figtree, sans-serif', letterSpacing: '0.08em' }}
      >
        750 mL
      </text>
      {/* highlight */}
