      ...
      <div className="mx-auto max-w-[1440px] px-6 pt-20 pb-8 lg:px-12">
        <div className="mb-16 flex flex-wrap items-end justify-between gap-8">
          <p className="font-display max-w-2xl text-4xl leading-[1.02] font-black uppercase sm:text-5xl">
            ...
            <br />
            <span className="text-orange">sem meias-medidas.</span>
          </p>
          <a
            href="#"
            className="flex h-14 items-center rounded-full border border-cream/25 px-8 text-sm font-bold transition-colors duration-200 hover:bg-cream hover:text-ink"
          >
            Falar com a equipa comercial
          </a>
        </div>

        <div className="grid grid-cols-2 gap-8 border-t border-cream/10 py-10 text-sm sm:grid-cols-4">
          {[
            ...
            <div key={col.title}>
              <p className="mb-4 text-xs font-bold tracking-[0.18em] text-orange">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-t border-cream/10 pt-8 text-xs opacity-50">
